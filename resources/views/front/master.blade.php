        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            <div class="container">
                ...
                <div class="mx-auto order-0 navbar-brand mx-auto">
                    <a href="{{$settings->insta_link}}" target="_blank"><i
                            class="fab fa-instagram github">&nbsp;&nbsp;</i></a>
                    <a href="{{$settings->fb_link}}"><i
                            class="fab fa-facebook-f facebook">&nbsp;&nbsp;</i></a>
                    <a href="{{$settings->tw_link}}"><i class="fab fa-twitter twitter">&nbsp;&nbsp;</i></a>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <ul class="options">
                        ...
                        <li><a href="{{$settings->app_store_url}}"><img src="{{asset('front/imgs/ios1.png')}}" alt=""></a></li>
                        <li><a href="{{$settings->play_store_url}}"><img src="{{asset('front/imgs/google1.png')}}" alt=""></a></li>
                    </ul>
                </div>
            </div>
        </div>
